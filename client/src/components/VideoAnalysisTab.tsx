    ...
    return (
      <div className="space-y-6">
        ...
        {parseAiFeedback(selectedAnalysis) && (() => {
          const fb = parseAiFeedback(selectedAnalysis)!;
          return (
          <Card className="bg-card border-border">
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">{fb.overallAssessment}</p>
              </div>
              ...
              <div>
                ...
                <div className="grid gap-3">
                  {fb.mechanicsBreakdown.map((phase, i) => (
